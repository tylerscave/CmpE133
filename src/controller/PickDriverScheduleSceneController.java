...
public class PickDriverScheduleSceneController implements Initializable {
    ...
    private DriveChoice selectedRide;
    ...
    @FXML
    private ComboBox<DriveChoice> pickRideCombo;
	...
	private void handlePickDriverCombo(ActionEvent event) {
		selectedRide = pickRideCombo.getSelectionModel().getSelectedItem();
	}
	 ...
	 * makes a ride request and populates the pickRideCombo box with a list of available 
